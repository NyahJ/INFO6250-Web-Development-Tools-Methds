...
import { fetchLimitNewBadRecord } from "../../services/recordservices";
import ErrorModal from "../modals/ErrorModal";

const LimitEditionRecord = ({ setIsLoggedIn }) => {
        ...
        <form>
          <div className="record-data-1">
            ...
            <input
              type="text"
              value={recordName}
              placeholder="Example : diamonds"
              onChange={(e) => setRecordName(e.target.value)}
            ></input>
          </div>
          <div className="record-data-2">
            <label htmlFor="goal">Limited Volume:</label>
            <input
              id="goal"
              type="number"
              value={goal}
...
export default LimitEditionRecord;
